...
HD_PWD='C:/Users/AERO/source/RC5_complete/RC5_complete.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RC5_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RC5_top.tcl
